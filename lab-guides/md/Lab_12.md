...
[]{#ch12}Chapter 12. Advanced Analytics with Tableau {#chapter-12.-advanced-analytics-with-tableau .title}
----------------------------------------------------
...
[]{#ch12lvl1sec114}Technical requirements {#technical-requirements .title style="clear: both"}
-----------------------------------------
...
`Rserve`{.literal} library. To install the `Rserve`{.literal} library,
open a new R script by navigating to **`File `**\| **`New script`**:

::: {.mediaobject}
![](2_files/ba1a606e-51bb-4462-8f57-9be4ba50cde4.png)
:::
...
::: {.mediaobject}
![](2_files/19e7f2e9-c369-4a44-ab0c-ddf150c78459.png)
:::

or by pressing [*Ctrl*]{.emphasis} + [*R*]{.emphasis} on your keyboard.



[]{#ch12lvl1sec115}Introduction {#introduction .title style="clear: both"}
-------------------------------
...
[]{#ch12lvl1sec116}Running segmentation analysis {#running-segmentation-analysis .title style="clear: both"}
------------------------------------------------
...
Cluster analysis is one of the most popular[]{#id326676236 .indexterm}
...
### []{#ch12lvl2sec382}Getting ready {#getting-ready .title}
...
In this recipe, we\'ll be using the `mtcars.csv`{.literal} dataset. It
...
### []{#ch12lvl2sec383}How to do it... {#how-to-do-it .title}
...
::: {.orderedlist}
1.  After connecting to the `mtcars.csv`{.literal} dataset, open a new
    blank worksheet.
...
::: {.mediaobject}
![](4_files/9be63081-1e3d-411b-9a9f-d51fe4ed6260.png)
:::
...
::: {.mediaobject}
![](4_files/3451a194-2463-43fc-9bdb-fbdb122e9b11.png)
:::
...
::: {.mediaobject}
![](4_files/a3bffc8c-31ed-47d9-b7f6-caf44866459e.png)
:::
...
::: {.mediaobject}
![](4_files/dadb964b-58e6-4011-932a-776c29c650e0.png)
:::
...
8.  In the **`Clusters`** window that opened, we can see two measures
    ...
    the [*Ctrl*]{.emphasis} key on your keyboard:
:::

::: {.mediaobject}
![](4_files/8d3d2cfc-dcfa-442b-adb8-f0830c685221.png)
:::
...
::: {.mediaobject}
![](4_files/8efa15c5-60a8-40e6-853a-b288f4cebe3b.png)
:::

::: {.orderedlist}
10. Click on **`X`** to close[]{#id325368476 .indexterm}
    the **`Clusters`** window.
...
### []{#ch12lvl2sec384}How it works\... {#how-it-works... .title}
...
::: {.mediaobject}
![](4_files/2640430e-fb7b-4c47-a005-62f135277c9c.png)
:::
...
::: {.mediaobject}
![](4_files/187bcf3a-751e-4ac9-bb97-35daa2a10ff5.png)
:::
...
::: {.mediaobject}
![](4_files/cecd5df6-f91e-4b68-a90c-e786213adf4b.png)
:::
...
### []{#ch12lvl2sec385}There\'s more\... {#theres-more... .title}
...
::: {.mediaobject}
![](4_files/aad799a8-93dc-41d2-bdd4-12a2a3f00d28.png)
:::
...
3.  Under **`Number of Clusters`**, type in the desired number of
    clusters. This time, let\'s go with `3`{.literal}:
:::

::: {.mediaobject}
![](4_files/0c1f9a29-123e-47f0-b68c-01c6e2f0ecc0.png)
:::
...
::: {.mediaobject}
![](4_files/6bc2faa1-d56b-498a-bc2c-02cabc45992f.png)
:::

::: {.note style="margin-left: 0.5in; margin-right: 0.5in;"}
### []{#tip39}Note {#note .title}
...
### []{#ch12lvl2sec386}See also {#see-also .title}
...
[]{#ch12lvl1sec117}Discovering the latent structure of the dataset {#discovering-the-latent-structure-of-the-dataset .title style="clear: both"}
------------------------------------------------------------------
...
When dealing with complex topics, we usually[]{#id325285853 .indexterm}
...
analysis**]{.strong} ([**PCA**]{.strong}), which is a data reduction
...
underlying the analysis [**singular value decomposition**]{.strong}
([**SVD**]{.strong}) is somewhat[]{#id325272535 .indexterm} complex, so
...
smaller number of [**principal components**]{.strong} in a way that
...
### []{#ch12lvl2sec387}Getting ready {#getting-ready .title}
...
::: {.note style="margin-left: 0.5in; margin-right: 0.5in;"}
### []{#note40}Note {#note .title}

For that task, we\'ll use the `prcomp`{.literal} function that\'s
built-in R.
:::
:::
...
### []{#ch12lvl2sec388}How to do it... {#how-to-do-it .title}
...
3.  Select the entire code and click the **`Run`** icon 
    ::: {.mediaobject}
    ![](5_files/19e7f2e9-c369-4a44-ab0c-ddf150c78459.png)
    :::

     . Alternatively, use [*Ctrl*]{.emphasis}+[*R*]{.emphasis} to run
    the code.
4.  Two files have now been created at the location you specified:
    `pt.loadings.csv`{.literal} and `scores.csv`{.literal}. We\'ll now
    use them to create a visualization in Tableau. Launch Tableau.
5.  From the **`Connect`** pane, select **`Text file`** and navigate to
    either of the files you have created---`pt.loadings.csv`{.literal}
    or `scores.csv`{.literal}. Select it and click **`Open`**.
...
::: {.mediaobject}
![](5_files/1bfdf4d3-4c36-438d-b222-fe9ef03089b7.png)
:::
...
::: {.mediaobject}
![](5_files/fb43bd78-c26c-4b7a-aa15-da2d93f03e53.png)
:::
...
::: {.mediaobject}
![](5_files/bfd1d7cc-2fb7-46de-8113-698e80dabc33.png)
:::
...
::: {.mediaobject}
![](5_files/77c4fb3e-40eb-4578-88d5-f501ea11a069.png)
:::
...
::: {.mediaobject}
![](5_files/521fed64-da3d-4250-bcef-149ac62ba246.png)
:::
...
::: {.mediaobject}
![](5_files/312d10ad-2bcb-498c-adee-61cc531bc489.png)
:::

::: {.note style="margin-left: 0.5in; margin-right: 0.5in;"}
### []{#tip41}Note {#note-1 .title}
...
### []{#ch12lvl2sec389}How it works\... {#how-it-works... .title}
...
the center of the chart. Values on [*x*]{.emphasis} and
[*y*]{.emphasis}-axes are actually the first and the second principal
...
new file, `scores.csv`{.literal}, where we recorded the scores of
...
`pt.loadings.csv`{.literal} dataset, where we recorded loading of each
...
[*y*]{.emphasis}-axis, is defined by **`Fairness`**, **`Gentleness`**,
...
### []{#ch12lvl2sec390}There\'s more... {#theres-more .title}
...
### []{#ch12lvl2sec391}See also {#see-also .title}
...
::: {.itemizedlist}
-   For more information on PCA, you may want[]{#id326678949 .indexterm}
    to start here:
    <https://en.wikipedia.org/wiki/Principal_component_analysis>
-   To find out more about the `prcomp`{.literal} function that we used
...
[]{#ch12lvl1sec118}Extracting the structure beneath discrete variables {#extracting-the-structure-beneath-discrete-variables .title style="clear: both"}
----------------------------------------------------------------------
...
### []{#ch12lvl2sec392}Getting ready {#getting-ready .title}
...
In this recipe, we\'ll use `telco_image.csv`{.literal}, a dataset coming
...
`telco_image.csv`{.literal} dataset to your device.
:::
...
### []{#ch12lvl2sec393}How to do it... {#how-to-do-it .title}
...
3.  Select the entire code and click on the **`Run`** icon
    ::: {.mediaobject}
    ![](6_files/19e7f2e9-c369-4a44-ab0c-ddf150c78459.png)
    :::

    . Alternatively, use [*Ctrl *]{.emphasis}+ [*R*]{.emphasis} to run
    the code.
4.  A new file, `CA_input_data.csv`{.literal}, has now been created at
...
::: {.orderedlist}
5.  From the **`Connect`** pane, select **`Text file`** and navigate to
    `CA_input_data.csv`{.literal}, then select it and click
    on **`Open`**.
...
::: {.mediaobject}
![](6_files/8807029b-4534-4b52-8b71-07b4f589e631.png)
:::
...
::: {.mediaobject}
![](6_files/57390353-6687-4092-a853-c72c38543895.png)
:::
...
::: {.mediaobject}
![](6_files/72384ed2-013e-420e-b192-fd35710ff1f1.png)
:::
...
::: {.mediaobject}
![](6_files/6be4db3f-2e90-4dfd-9c2a-fe2640ec6de3.png)
:::
:::
...
### []{#ch12lvl2sec394}How it works\... {#how-it-works... .title}
...
[*x*]{.emphasis} and [*y*]{.emphasis} axes, we plotted the first two
...
### []{#ch12lvl2sec395}There\'s more\... {#theres-more... .title}
...
[*y*]{.emphasis}axis could be interpreted[]{#id325442067 .indexterm} as
ranging from affordable/simple offer to high-tech/innovative, while the
[*x*]{.emphasis} axis could be interpreted as being
...
### []{#ch12lvl2sec396}See also {#see-also .title}
...
-   For more information on the R `ca`{.literal} package that
...
[]{#ch12lvl1sec119}Data mining with tree-based models {#data-mining-with-tree-based-models .title style="clear: both"}
-----------------------------------------------------
...
### []{#ch12lvl2sec397}Getting ready {#getting-ready .title}
...
In this recipe, we\'ll be using the `new_or_used_car.csv`{.literal}
...
have a dimension, `Future Purchase`{.literal}, which lets us know
whether they\'re planning to buy a new or used car.

Before we dive into the recipe, please make sure you have the
`new_or_used_car.csv`{.literal} dataset saved to your device.
:::
...
### []{#ch12lvl2sec398}How to do it... {#how-to-do-it .title}
...
3.  Run the entire block of code by selecting it clicking the **`Run`**
    button
    ::: {.mediaobject}
    ![](7_files/19e7f2e9-c369-4a44-ab0c-ddf150c78459.png)
    :::

    or by pressing [*Ctrl*]{.emphasis} + [*R*]{.emphasis} on your
    keyboard.
4.  In order to make the connection with Tableau possible, call the
    `Rserve`{.literal} library by running the following code:
:::
...
::: {.orderedlist}
5.  Open Tableau and connect to the `new_or_used_car.csv`{.literal}
    dataset.
...
::: {.orderedlist}
7.  In the **`Server`** field, enter `localhost`{.literal}.
8.  In the **`Port`** field, enter `6311`{.literal}.
...
10. After receiving the message[]{#id325192616 .indexterm} that you\'re
    successfully connected to the `RServe`{.literal} service, click
...
::: {.mediaobject}
![](7_files/84b1cbc8-ab11-465d-be0e-f943afc47333.png)
:::
:::
...
### []{#ch12lvl2sec399}How it works\... {#how-it-works... .title}
...
### []{#ch12lvl2sec400}There\'s more {#theres-more .title}
...
`.rda`{.literal} file at your computer and reuse it with a new dataset.
...
multiple regression*]{.emphasis} recipe in [Chapter
11](https://subscription.packtpub.com/book/data/9781789533385/11){.link},
[*Forecasting with Tableau*]{.emphasis}.
:::
...
### []{#ch12lvl2sec401}See also {#see-also .title}
...
-   For more information about the `rpart`{.literal} library we
    used[]{#id326680928 .indexterm} in this recipe, start here:
    <https://cran.r-project.org/web/packages/rpart/rpart.pdf>



[]{#ch12lvl1sec120}Identifying anomalies in data {#identifying-anomalies-in-data .title style="clear: both"}
------------------------------------------------
...
11](https://subscription.packtpub.com/book/data/9781789533385/11){.link},
[*Forecasting with Tableau*]{.emphasis}, the [*Forecasting on a dataset
with outliers*]{.emphasis} recipe taught up how to deal with outliers on
...
### []{#ch12lvl2sec402}Getting ready {#getting-ready .title}
...
pressure, `age_and_blood_pressure.csv`{.literal}. It contains
...
### []{#ch12lvl2sec403}How to do it... {#how-to-do-it .title}
...
2.  Open Tableau and connect to
    the `age_and_blood_pressure.csv`{.literal} file.
...
4.  In the **`Server`** field, enter `localhost`{.literal}.
5.  In the **`Port`** field, enter `6311`{.literal}.
6.  Click on the **`Test Connection`** button.
7.  After receiving a message that you\'re successfully connected to
    the `RServe`{.literal} service, click on **`OK`** to close the
...
11. Rename the new calculated field `Outliers`{.literal} and enter the
    following code:
:::
...
::: {.mediaobject}
![](8_files/b41cae9d-dd75-4f98-8bfd-2c9cbcefdb9f.png)
:::
:::
...
### []{#ch12lvl2sec404}How it works\... {#how-it-works... .title}
...
### []{#ch12lvl2sec405}There\'s more\... {#theres-more... .title}
...
`uniplot`{.literal} function
(<https://www.rdocumentation.org/packages/mvoutlier/versions/2.0.9/topics/uni.plot>)
from the `mvoutlier`{.literal} package in R, which allows you to unfold
...
### []{#ch12lvl2sec406}See also {#see-also .title}
...
::: {.itemizedlist}
-    To find out more about the `mvoutlier`{.literal} package we used in
